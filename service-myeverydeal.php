<?php 
    ...
    $_SESSION['page-title-content-box'] = 'MyEveryDeal';
    $_SESSION['page-title-bread-crumb'] = "<li>MyEveryDeal</li>";
                ...
                <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                    <div class="service-details-content">
                        <div class="content-style-one">
                            <figure class="image-box"><img src="assets/images/service/service-16.jpg" alt=""></figure>
                            <div class="sec-title left">
                                <h5>Online Unified Market</h5>
                                <h2>Best Nigerian Online Unified Marketplace for Hard-To-Get Products</h2>
                            </div>
                            <div class="text">
                                <p>A B2C ecommerce platform catering to hard-to-get everyday utility products and using a network of last mile logistics partners to take out presence closer to our customers thereby making ecommerce available in underserved locations at affordable cost. We focus on and give visibility to emerging utility products that are not stocked by traditional merchants and this gives us a competitive advantage. </p>
                            </div>
                    ...
                    <div class="service-sidebar">
                        <div class="sidebar-categories">
                            <ul class="categories-list clearfix">
                                ...
                                <li><a href="wealth-marketing.html" class="active">Wealth Marketing</a></li>
                        ...
                        <div class="download-option">
                            ...
                            <ul class="download-file clearfix">
                                <li><a href="financial-analysis.html"><i class="fas fa-file-pdf"></i>Presentation PDF</a></li>
