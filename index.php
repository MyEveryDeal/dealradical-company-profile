...
?>
            ...
            <div class="slide-item">
                ...
                <div class="auto-container">
                    <div class="content-box">
                        ...
                        <h1>Building trust between <br/>businesses and customers </h1>
                        <div class="btn-box">
                            <a href="contact.html" class="theme-btn style-one">How Can We Help</a>
                            <a href="#" class="user-btn"><i class="far fa-user"></i><span>Find a
                                    Consultant</span></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="slide-item">
                ...
                <div class="auto-container">
                    <div class="content-box centred">
                        ...
                        <h1>Provide satisfactory services <br /> to business and customers</h1>
                        <div class="btn-box">
            ...
            <div class="row clearfix">
                <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                    <div id="content_block_13">
                        <div class="content-box">
                            ...
                            <div class="text">
                                <p class="d-flex align-content-between flex-wrap">DealRadical Limited through its
                                    different products focuses on providing solution
                                    to the various challenges along Ecommerce transaction value chain limiting SMEs in
                                    the
                                    unstructured informal markets in Nigeria and across Africa from reliably offering
                                    and
                                    accessing value remotely beyond their geographical locality. Our products and
                                    services
                                    designed to address these challenges includes
                                </p>
                                <ul>
                                    <li><span class="fas fa-check-double text-danger mr-2"></span>MyEveryDeal</li>
                                    <li><span class="fas fa-check-double text-danger mr-2"></span>Zigaya</li>
                                    <li><span class="fas fa-check-double text-danger mr-2"></span>Supbuyers</li>
                                </ul>
                            </div>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                    <div id="image_block_four">
                        <div class="image-box">
                            <div class="pattern-layer" style="background-image: url(assets/images/shape/shape-23.png);">
                            </div>
                            <figure class="image wow slideInRight animated animated" data-wow-delay="00ms"
                                data-wow-duration="1500ms"><img src="assets/images/resource/about-3.jpg" alt="">
                            </figure>
                        </div>
                    </div>
                </div>
    ...
    <!-- info-section -->
    <section class="info-section bg-color-1">
        <div class="auto-container">
            <div class="row clearfix">
                    ...
                    <div class="title-inner">
                        <div class="year-box">
                            <figure class="image-box">
                                <img src="assets/images/icons/year-icon.png" alt=""></figure>
                            <h2>2</h2>
                            <h3><small style="font-size: small;">DealRadicals</small></h3>
                        </div>
                        <div class="title">
                ...
                <div class="col-lg-5 col-md-12 col-sm-12 text-column">
                    <div class="text">
                        <p>Began operation in 2021 with MyEveryDeal catering for B2C customer and the company became incorporated in July the same year</p>
            ...
            <div class="tabs-box">
                <div class="tab-btn-box">
                    <!-- <ul class="tab-btns tab-buttons clearfix">
                            <li class="tab-btn active-btn" data-tab="#mission-tab">
                ...
                <div class="tabs-content">
                    <div class="tab active-tab" id="mission-tab">
                        <div class="row align-items-center clearfix">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 content-column">
                                <div class="content-box">
                                    <h3>Mission</h3>
                                    <p>Platforming and automating reliable stress-free offer and access to value in the
                                        SME dominated unstructured informal markets across Africa from anywhere by
                                        implementing a composite Transaction Support Infrastructure as a Service Social
                                        Good especially along the B2B Ecommerce transaction value chain</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                    <div id="content_block_13">
                        <div class="content-box">
                            ...
                            <div class="text">
                                <p class="d-flex align-content-between flex-wrap">
                                    DealRadical Limited is an early stage startup founded by a team of experienced
                                    entrepreneurs and techies lead by Delight Aniche. We began operation in 2021 with
                                    MyEveryDeal catering for B2C customer and the company became incorporated in July
                                    the same year.
                                    The company enrolled in the Founder Insititute Acceleration program to strengthen
                                    further, our ability to deliver on the problem we want to solve for the native
                                    informal commerce ecosystem. Our mission is to make commerce stress-free using
                                    technology.
                                </p>
                                <p class="d-flex align-content-between flex-wrap">
                                    MyEveryDeal is one of the fastest growing ecommerce platforms in Nigeria and
                                    currently operates in over 40 locations across 31 states in Nigeria and 3 regions in
                                    Ghana.
                                    Zigani our logistics arm began has begun teething operation in selected cities
                                    around the country with more to come in the first quarter of 2023.
                                    Our field research and marketing team has been intensively researching the market
                                    and laying the foundation for the roll out of our other products.
                                </p>
    ...
    <!-- mission-style-four end -->


    <!-- service-style-five -->
    <section class="service-style-five bg-color-1" id="our-services-section">
        <div class="auto-container">
            <div class="sec-title style-four right" >
            ...
            <div class="tabs-box">
                ...
                <div class="tabs-content">
                    <div class="tab active-tab" id="tab-1">
                        <div class="row align-items-center clearfix">
                            <div class="col-lg-6 col-md-6 col-sm-12 image-column">
                                <figure class="image-box"><img src="assets/images/service/service-myeverydeal-2.png"
                                        alt="">
                                </figure>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 content-column">
                                <div class="content-box">
                                    <h3>MyEveryDeal</h3>
                                    <p>A B2C ecommerce platform catering to hard-to-get everyday utility products and
                                        using a network of last mile logistics partners to take out presence closer to
                                        our customers thereby making ecommerce available in underserved locations at
                                        affordable cost. We focus on and give visibility to emerging utility products
                                        that are not stocked by traditional merchants and this gives us a competitive
                                        advantage. </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tab" id="tab-2">
                        <div class="row align-items-center clearfix">
                            <div class="col-lg-6 col-md-6 col-sm-12 image-column">
                                <figure class="image-box"><img src="assets/images/service/service-zigaya.jpeg" alt="">
                                </figure>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 content-column">
                                <div class="content-box">
                                    <h3>Zigaya</h3>
                                    <p>A regulated B2B Ecommerce Marketplace that platforms and connects merchants to
                                        the right suppliers in various distant wholesale markets without the stress of
                                        physically travelling to the market. Major dealers and manufacturers are very
                                        busy attending to foot traffic customers in front of them that they hardly find
                                        the time to attend to remote customers at the comfort of their shop or homes
                                        while the foot traffic customers had to lockup business for days to travel for
                                        restocking. Our solution leverages digital technology, hustlers and trust
                                        protocols to bring a new customer experience to restocking for remote retailers.
                                    </p>
                                    <!-- <ul class="list-item clearfix">
                    ...
                    <div class="tab" id="tab-3">
                        <div class="row align-items-center clearfix">
                            <div class="col-lg-6 col-md-6 col-sm-12 image-column">
                                <figure class="image-box"><img src="assets/images/service/service-supbuyer-2.jpg"
                                        style="width: 600px; height: 350px;" alt="">
                                </figure>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 content-column">
                                <div class="content-box">
                                    <h3>Supbuyers</h3>
                                    <p>A Transaction Support Infrastructure Services that facilitates reliable remote
                                        transaction on behalf of the physically absent buyer by carrying out sourcing
                                        and filtering verification, validation, collation, handling, documentation,
                                        packaging, onwarding, etc. using a web of reliable agents with narrow but deep
                                        specialization in their field. Leveraging the power of social media, we
                                        aggregate and map merchants and knowledges in the unstructured informal markets
                                        to create an Online Entrepreneurs Support Community Network aimed at inspiring,
                                        training and supporting aspiring entrepreneur. </p>
                                    <!-- <ul class="list-item clearfix">
                                        <li>Acepteur sintas haecat sed non duiy</li>
                                        <li>Proident sunt culpa sed ipsum tempor sed</li>
                                        <li>Ut enim ad minim veniam quis nostrud exercitation</li>
                    ...
                    <div class="tab" id="tab-4">
                        <div class="row align-items-center clearfix">
                            <div class="col-lg-6 col-md-6 col-sm-12 image-column">
                                <figure class="image-box"><img src="assets/images/service/service-4.jpg" alt="">
                                </figure>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 content-column">
                                <div class="content-box">
                    ...
                    <div id="content_block_two">
                        <div class="content-box">
                            <div class="sec-title left">
                                ...
                                <h2>Technologies, Markets and Distribution</h2>
                            </div>
                            <div class="text">
                                <p>Leveraging on modern technologies, open markets and accessiable distribution channels
                                </p>
                            </div>
                            <section class="service-style-five bg-color-1 p-0">
                                <div class="auto-container ">
                                    <div class="tabs-box">
                                        <div class="tab-btn-box mb-0">
                                            <ul class="tab-btns tab-buttons clearfix">
                                                <li class="tab-btn active-btn" data-tab="#technologies-tab">
                                                    <i class="flaticon-rocket"></i>
                                                    Technologies
                                                </li>
                                                <li class="tab-btn" data-tab="#markets-tab">
                                                    <i class="flaticon-innovation-1"></i>
                                                    Markets
                                                </li>
                                                <li class="tab-btn" data-tab="#distribution-tab">
                                                    <i class="flaticon-growth-3"></i>
                                                    Distribution
                                                </li>
                                            </ul>
                                        ...
                                        <div class="tabs-content">
                                            <div class="tab active-tab" id="technologies-tab">
                                                <div class="row align-items-center clearfix">
                                                    <!-- <div class="col-lg-6 col-md-6 col-sm-12 image-column">
                                                        <figure class="image-box"><img src="assets/images/service/service-4.jpg" alt="">
                                                        </figure>
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12 content-column">
                                                        <div class="content-box">
                                                            <h3>Technologies</h3>
                                                            <p>We are leveraging different aspects of ICT like AI,
                                                                machine learning, GPS tracking secureAPIs etc. to drive
                                                                our innovative products.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="tab" id="markets-tab">
                                                <div class="row align-items-center clearfix">
                                                    <!-- <div class="col-lg-6 col-md-6 col-sm-12 image-column">
                                                        <figure class="image-box"><img src="assets/images/service/service-4.jpg" alt="">
                                                        </figure>
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12 content-column">
                                                        <div class="content-box">
                                                            <h3>Markets</h3>
                                                            <p>Our service will enable service consumers, retailers and
                                                                bulk buyers access varieties of service providers,
                                                                suppliers and products and purchase stock from the
                                                                convenience an d have it safely delivered to them.
                                                                Therefore our core target market are manufacturers,
                                                                major distributors, wholesalers, retailers and bulk
                                                                buyers in the unstructured informal markets. The
                                                                Nigerian B2B ecommerce market size according to
                                                                Busisnessday is $100bn and growth at a rate of 43% per
                                                                year. We will employ a freemium and service charge
                                                                revenue model to grow fast and dominate the market.</p>
                                                            <!-- <ul class="list-item clearfix">
                                                                <li>Acepteur sintas haecat sed non duiy</li>
                                                                <li>Proident sunt culpa sed ipsum tempor sed</li>
                                                                <li>Ut enim ad minim veniam quis nostrud exercitation</li>
                                            ...
                                            <div class="tab" id="distribution-tab">
                                                <div class="row align-items-center clearfix">
                                                    <!-- <div class="col-lg-6 col-md-6 col-sm-12 image-column">
                                                        <figure class="image-box"><img src="assets/images/service/service-4.jpg" alt="">
                                                        </figure>
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12 content-column">
                                                        <div class="content-box">
                                                            <h3>Distribution</h3>
                                                            <p>Our service will live with our customers hence we will
                                                                use mobile app to put our solution in their pocket, our
                                                                field teams resident in the markets and doing the heavy
                                                                liftings for the customer and importantly empowering
                                                                market hustlers to make their daily living by using our
                                                                solution. We therefore will be using direct salesforce
                                                                mainly to distribute our solution.</p>
                                                            <!-- <ul class="list-item clearfix">
                                                                <li>Acepteur sintas haecat sed non duiy</li>
                                                                <li>Proident sunt culpa sed ipsum tempor sed</li>
                                                                <li>Ut enim ad minim veniam quis nostrud exercitation</li>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                    <div id="image_block_one">
                        <div class="image-box">
                            ...
                            <figure class="image"><img src="assets/images/resource/strategies.jpeg" alt=""></figure>
                            <div class="award-box">
                                <div class="box">
    ...
    <section class="world-cyber bg-color-1">
        <div class="auto-container">
            <div class="sec-title centred">
                <h5>Covering the Globe</h5>
                <h2>Expanding Across Africa</h2>
            </div>
            <!-- funfact-style-four -->
                ...
                <div class="auto-container">
                    <div class="row clearfix">
                        <div class="col-lg-3 col-md-6 col-sm-12 counter-column">
                            <div class="counter-block-four wow slideInUp" data-wow-delay="00ms"
            ...
            <div class="row clearfix">
                <div class="col-lg-3 col-md-6 col-sm-12 team-block">
                    <div class="team-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><img src="assets/images/team/CEO-delight.jpeg" alt=""></figure>
                            <div class="lower-content">
                                <div class="content-box">
                                    <h3><a href="index-2.html">Delight Aniche</a></h3>
                                    <span class="designation">Founder/CIO</span>
                                </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 team-block">
                    <div class="team-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><img src="assets/images/team/HOM-gloria.jpg" alt=""
                                    style="width: 180px;"></figure>
                            <div class="lower-content">
                                <div class="content-box">
                                    <h3><a href="index-2.html">Gloria Jacob</a></h3>
                                    <span class="designation">Cofounder/CEO</span>
                                </div>
                                <div class="ovellay-box">
                                    <h3><a href="index-2.html">Gloria Jacob</a></h3>
                                    <span class="designation">Cofounder/CEO</span>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 team-block">
                    <div class="team-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><img src="assets/images/team/HOP-confident.jpg"
                                    style="width:195px;"></figure>
                            <div class="lower-content">
                                <div class="content-box">
                                    <h3><a href="index-2.html">Confidence Aniche</a></h3>
                                    <span class="designation">Cofounder/COO</span>
                                </div>
                                <div class="ovellay-box">
                                    <h3><a href="index-2.html">Confidence Aniche</a></h3>
                                    <span class="designation">Cofounder/COO</span>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 team-block">
                    <div class="team-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><img src="assets/images/team/CTO-Kelvin.jpeg"
                                    style="width:270px;"></figure>
                            <div class="lower-content">
                                <div class="content-box">
                                    <h3><a href="index-2.html">Kelvin Mgbemele</a></h3>
        ...
        <div class="auto-container">
            <div class="row clearfix">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 counter-column">
                    <div class="counter-block-one wow slideInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="count-outer count-box">
                            <span class="count-text" data-speed="1500" data-stop="3">3</span>
                        </div>
                        <p>Active Services</p>
                    </div>
                </div>
