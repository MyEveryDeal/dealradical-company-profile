    ...
    <section class="contact-information centred">
        <div class="auto-container">
            <div class="sec-title right">
                <h5>Get in touch</h5>
                <h3>We’re Provide B2B Transaction Support Infrastructure as a Service <br />To Help With your Business</h3>
            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 single-column">
                    <div class="single-item wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            ...
                            <p>19 Mishalia Street, Mando Kaduna, Nigeria</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 single-column">
                    <div class="single-item wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            ...
                            <h3>Tel:</h3>
                            <p>Tel 1  <a href="tel:+2348066190662">+2348066190662</a></p>
                            <p>Tel 2 <a href="tel:+2347017518376">+2347017518376</a></p>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 single-column">
                    <div class="single-item wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            ...
                            <p>
                                <a href="mailto:delight.aniche@gmail.com ">delight.aniche@gmail.com </a>
                                <br /><a href="mailto:reply@example.org">anichec40@gmail.com</a></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="auto-container">
            <div class="col-xl-8 col-lg-12 col-md-12 inner-column">
                <div class="sec-title left light">
                    <h5>Mail Us</h5>
                    <h2>Drop Us a message/enquiry</h2>
                    <p>You can reach out to us for enquiry, drop a message, comment or ideas on how to serve you better  </p>
                </div>
    ...
    <section class="google-map-section">
        <div class="map-column">
            <div class="google-map-area">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1842.0069802594107!2d7.39683686148267!3d10.595942756308563!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x11b2ca4b0d9f38cb%3A0xb3fbcbc6a246572e!2sMando%20Market%20Kaduna!5e0!3m2!1sen!2sng!4v1676012918199!5m2!1sen!2sng"  height="450" style="border:0; width: 100%;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
        </div>
    </section>
