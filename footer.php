...
<footer class="main-footer">
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-3 col-md-6 col-sm-12 footer-column">
                            <div class="footer-widget logo-widget">
                                <figure class="footer-logo">
                                    <a href="index.php"><img src="assets/images/logo-myeverydeal.png" alt="" /></a>
                                </figure>
                                <div class="text">
                                ...
                                <ul class="info-list clearfix">
                                    <li><i class="fas fa-map-marker-alt"></i>19 Mishalia Street, Mando Kaduna,</li>
                                    <li><i class="fas fa-envelope"></i>Email <a
                                            href="mailto:delight.aniche@gmail.com ">delight.aniche@gmail.com</a></li>
                                    <li><i class="fas fa-headphones"></i>Tel <a
                                            href="tel:+2348066190662">+2348066190662</a></li>
                                </ul>
                            ...
                            <div class="footer-widget links-widget ml-70">
                                ...
                                <div class="widget-content">
                                    <ul class="list clearfix">
                                        ...
                                        <li><a href="index.php">What We Offers</a></li>
                                        <li><a href="index.php">Testimonials</a></li>
                                        <li><a href="index.php">Our Projectss</a></li>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 footer-column">
                            <div class="footer-widget links-widget">
                                ...
                                <div class="widget-content">
                                    <ul class="list clearfix">
                                        <li><a href="index.php">Financial Advice</a></li>
                                        <li><a href="index.php">Business Planning</a></li>
                                        <li><a href="index.php">Startup Help</a></li>
                                        <li><a href="index.php">Investment Strategy</a></li>
                                        <li><a href="index.php">Management Services</a></li>
                                        <li><a href="index.php">Market Research</a></li>
                                        <li><a href="index.php">SEO Optimization</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
        ...
        <div class="footer-bottom">
            <div class="auto-container">
                <div class="copyright">
                    <p>&copy; 2020 <a href="index.php">FIONCA</a> - Business & Consulting. All rights reserved.</p>
                </div>
            </div>
        </div>
    </footer>
