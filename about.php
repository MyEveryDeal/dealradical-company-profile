...
?> 
                    ...
                    <div id="content_block_three">
                        <div class="content-box">
                            <div class="sec-title right">
                                <h5>About DealRadical</h5>
                                <h2>Business Description</h2>
                            </div>
                            <div class="text">
                                <p>DealRadical Limited through its different products focuses on providing solution to the various challenges along Ecommerce transaction value chain limiting SMEs in the unstructured informal markets in Nigeria and across Africa from reliably offering and accessing value remotely beyond their geographical locality. Our products and services designed to address these challenges include</p>
                            ...
                            <div class="tabs-box">
                                <div class="tab-btn-box">
                                    <ul class="tab-btns tab-buttons clearfix">
                                        ...
                                        <li class="tab-btn" data-tab="#tab-2">Markets</li>
                                        <li class="tab-btn" data-tab="#tab-3">Distribution Channels</li>
                                    </ul>
                                </div>
                                <div class="tabs-content">
                                    <div class="tab active-tab" id="tab-1">
                                        <div class="content-inner">
                                            <p>Platforming and automating reliable stress-free offer and access to value in the SME dominated unstructured informal markets across Africa from anywhere by implementing a composite Transaction Support Infrastructure as a Service Social Good especially along the B2B Ecommerce transaction value chain </p>
                                            <!-- <a href="about-1.html"><i class="fas fa-arrow-right"></i><span>Read More</span></a> -->
                                        </div>
                                    </div>
                                    <div class="tab" id="tab-2">
                                        <div class="content-inner">
                                            <p>Our service will enable service consumers, retailers and bulk buyers access varieties of service providers, suppliers and products and purchase stock from the convenience and have it safely delivered to them. Therefore our core target market are manufacturers, major distributors, wholesalers, retailers and bulk buyers in the unstructured informal markets. The Nigerian B2B ecommerce market size according to Busisnessday is $100bn and growth at a rate of 43% per year. We will employ a freemium and service charge revenue model to grow fast and dominate the market.  </p>
                                            <!-- <a href="about-1.html"><i class="fas fa-arrow-right"></i><span>Read More</span></a> -->
                                        </div>
                                    </div>
                                    <div class="tab" id="tab-3">
                                        <div class="content-inner">
                                            <p> Our service will live with our customers hence we will use mobile app to put our solution in their pocket, our field teams resident in the markets and doing the heavy liftings for the customer and importantly empowering market hustlers to make their daily living by using our solution. We therefore will be using direct salesforce mainly to distribute our solution. </p>
                                            <!-- <a href="about-1.html"><i class="fas fa-arrow-right"></i><span>Read More</span></a> -->
                                        </div>
                                    </div>
                                </div>
    ...
    <section class="world-cyber about-page-1">
        ...
        <div class="auto-container">
            <div class="sec-title centred">
                ...
                <h2>DealRadical’s Working Everywhere</h2>
            </div>
    ...
    <?php @include_once('components/team-section.php') ?>
